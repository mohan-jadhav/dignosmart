...
# This initializes a Flask web application, which will handle incoming HTTP requests.
...
# converet categorical variable into numaric variable
le = preprocessing.LabelEncoder()  
# Learns the mapping from the disease names to numbers
le.fit(y)
# Transforms the disease names into corresponding integers.
y = le.transform(y)
...
# Basic route that returns a message when the API is accessed
@app.route('/')
def home():
    return "I am ready!"
